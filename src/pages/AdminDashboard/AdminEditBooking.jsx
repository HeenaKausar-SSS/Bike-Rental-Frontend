...
function EditBooking({ id }) {
  ...
  useEffect(() => {
    if (!token) {
      ...
      axios.get(`${process.env.REACT_APP_BASE_URL}/api/v1/bookings/admin/booking`, {
        headers: {
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      axios.put(`${process.env.REACT_APP_BASE_URL}/api/bookings/admin/edit-vehicles/${id}`, formDataToSend, {
        headers: {
